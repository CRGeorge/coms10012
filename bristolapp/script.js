window.onload = function () {
  ...
  function populateWards(wards) {
    ...
    // wards.records.sort(function(a,b){return b.record.fields.name > a.record.fields.name});
    wards.records.sort((a,b) => (a.record.fields.name > b.record.fields.name) ? 1 : ((b.record.fields.name > a.record.fields.name) ? -1 : 0))
    wards.records.filter(wards => wards.records.timestamp > 2015);
    wards.records.sort((a,b) => {return b.record.fields.name > a.record.fields.name});
